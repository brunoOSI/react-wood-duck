...
class NavLinksContainer extends React.Component {
    ...
    getDefaultActiveNavLinkHref() {
        return ((this.props.navLinks && this.props.navLinks.navItems && this.props.navLinks.navItems.length > 0) ? this.props.navLinks.navItems[0].href : null);
    }
    ...
    render() {
        ...
        return <NavLinks navLinks={this.props.navLinks} handleClick={this.handleNavLinkClick} activeNavLinkHref={this.state.activeNavLinkHref}/>;
    }
}
